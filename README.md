...
| `client.blogs` | Articles and products that already live on a connected site: list the blogs, list, read, create, update and delete articles, list and update products |
